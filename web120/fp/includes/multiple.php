...
$toName = "David Cheyette"; //place your client's name here
$website = "Cheyette & Associates";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>
		<label style="color:#026c85; opacity: .75">
	...
	<div>	
		<label style="color:#026c85; opacity: .75">
			What brings you to our site?<br />
			<select name="What_would_you_like_to_bake?" required="required" title="What would you like to bake is required" tabindex="30">
				<option value="Service 1">Test</option>
				<option value="Service 2">Test</option>
				<option value="Servie 3">Cake</option>
				<option value="Service 4">Bread</option>
			</select>
		</label>
	</div>
	
	<div>	
		<fieldset style="color:#026c85; opacity: .75">
			<legend>What type of industry are you in?</legend>
			<input type="checkbox" name="Interested_In[]" value="Service 1" tabindex="40" /> Service 1<br />
			<input type="checkbox" name="Interested_In[]" value="Service 2" /> Service 2 <br />
			<input type="checkbox" name="Interested_In[]" value="Service 3" /> Service 3 <br />
			<input type="checkbox" name="Interested_In[]" value="Service 4" /> Service 4 <br />
			<input type="checkbox" name="Interested_In[]" value="Service 5" /> Service 5 <br />
		</fieldset>
        <label style="color:#026c85; opacity: .75">
			Other:<br /><textarea name="Elaborate" cols="36" rows="4" placeholder="If other, please let us know" tabindex="60"></textarea>
		</label>
	</div>
	
		<div>	
		<fieldset style="color:#026c85; opacity: .75">
			<legend>Would you like to receive information from us?</legend>
