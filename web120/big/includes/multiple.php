...
?>
	...
	<div>	
		<label>
			What does your business actually do?<br /><textarea name="Comments" cols="36" rows="4" placeholder="Let us know what your business does" tabindex="60"></textarea>
		</label>
	</div>
	<div>	
		<label>
			What do you want your site to accomplish?<br /><textarea name="Comments" cols="36" rows="4" placeholder="What are you expecting from us?" tabindex="60"></textarea>
		</label>
	</div>
	<div>	
		<label>
			What makes your company remarkable?<br /><textarea name="Comments" cols="36" rows="4" placeholder="How are you different?" tabindex="60"></textarea>
		</label>
	</div>
	<div>	
		<label>
			Who do you compete with?<br /><textarea name="Comments" cols="36" rows="4" placeholder="Your competition" tabindex="60"></textarea>
		</label>
	</div>
	<div>	
		<label>
			What websites do you like?<br /><textarea name="Comments" cols="36" rows="4" placeholder="Also, why do you like them?" tabindex="60"></textarea>
		</label>
	</div>
	<div>	
		<label>
			Who are your customers?<br /><textarea name="Comments" cols="36" rows="4" placeholder="Who are you trying to reach?" tabindex="60"></textarea>
		</label>
	</div>
	<div>	
		<label>
